...
### Are You Sleeping (Seed → Generated Continuation)
<audio controls>
  <source src="samples/Are-You-Sleeping.mp3" type="audio/mpeg">
</audio>

### C-major Scale (Seed → Generated Continuation)
<audio controls>
  <source src="samples/C-Major-Scale.mp3" type="audio/mpeg">
</audio>
